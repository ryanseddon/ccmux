...
| `groupBy`                    | `project`, `worktree`, `cwd`, `session`, `window`, `none`                    | `project`          | How sessions are grouped in the TUI; `worktree` separates linked checkouts while retaining project groups for main checkouts       |
